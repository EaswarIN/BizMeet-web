...
$user = 'ehl-subscription'; // place SG username here
$pass = 'EVndVBeR'; // place SG password here
...
$to = array('support@bizmeet-hub.com');
...
for($i=0; $i<count($to); $i++){
 $params = array(
    'api_user'  => "$user",
    'api_key'   => "$pass",
    'to'        => $to[$i], // set TO address to have the contact form's email content sent to
    'subject'   => "BizMeet Contact Form Submission", // Either give a subject for each submission, or set to $subject
